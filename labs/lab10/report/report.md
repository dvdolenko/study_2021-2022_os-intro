...
![создание файла и изменение его прав](image/1.jpg){#fig:001 width=70%}

![справка по архиватору](image/2.jpg){#fig:002 width=70%}

![скрипт](image/3.jpg){#fig:003 width=70%}

![запускаю](image/4.jpg){#fig:004 width=70%}

![создан архив](image/5.jpg){#fig:005 width=70%}
...
![скрипт](image/10.jpg){#fig:010 width=70%}

![запуск и проверка](image/11.jpg){#fig:011 width=70%}
